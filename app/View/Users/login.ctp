            ...
            <div class="row">
                <div class="span12">
                    <div class="alert alert-info">
                        ...
                        <?php echo __('Bitte registrieren Sie sich oder melden Sie sich an, um Kurse zu buchen.'); ?>
                        <br/>
                        <?php echo __('Eine aktuelle Übersicht der Kurse können Sie auch ohne anmeldung einsehen.'); ?>
                    </div>
                </div>
            </div>
