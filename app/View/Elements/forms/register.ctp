<div class="well span5 offset1">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('title', array('empty' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('firstname', array('required' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('lastname', array('required' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('password', array('required' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('password_confirm', array('required' => true, 'type' => 'password', 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('email', array('required' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('department_id', array('empty' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('phone', array('required' => true, 'class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('hrz', array('class' => 'span3', 'label' => false)); ?>
        </div>
    </div>
    <hr/>

    <div class="form-controls">
        <input type="submit" class="btn btn-bluegrey btn-medium" value="<?php echo __('Registrieren'); ?>"/>
    </div>
